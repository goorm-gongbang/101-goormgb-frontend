...
const toneStyles: Record<Tone, string> = {
    strong: "bg-[var(--foundation-primary-600)] text-[var(--foundation-neutral-white)]",
    base: "bg-[var(--foundation-primary-500)] text-[var(--foundation-neutral-white)]",
    soft: "bg-[var(--foundation-primary-400)] text-[var(--foundation-neutral-white)]",
};
