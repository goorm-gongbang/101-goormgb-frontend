...
type HomeClientProps = {
  initialDate: string;
  initialMatchesPayload: MatchesData | null;
  initialTeamsPayload: ClubsData | null;
};

export default function HomeClient({
  initialDate,
  initialMatchesPayload,
  initialTeamsPayload,
}: HomeClientProps) {
  ...
  const [teamsPayload] = useState<ClubsData | null>(initialTeamsPayload);
  ...
  }, [selectedDate, initialDate, initialMatchesPayload]);
